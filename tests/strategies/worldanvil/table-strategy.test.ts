import { WorldAnvilTableConversionStrategy } from '../../../src/strategies/worldanvil/table-strategy';

describe('WorldAnvilTableConversionStrategy', () => {
  let strategy: WorldAnvilTableConversionStrategy;

  beforeEach(() => {
    strategy = new WorldAnvilTableConversionStrategy();
  });

  describe('convert', () => {
    it('should convert a simple markdown table to WorldAnvil BBCode format', () => {
...
`;
      ...
      const result = strategy.convert(input, 'worldanvil');
