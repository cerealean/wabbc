...
import { ImageConversionStrategy } from '../../../src/strategies/standard/image-strategy';

describe('Standard ImageConversionStrategy', () => {
  ...
  test('should handle multiple images', () => {
    ...
    const result = strategy.convert(markdown);
    expect(result).toBe(`[img]${url1}[/img] [img]${url2}[/img]`);
  });
