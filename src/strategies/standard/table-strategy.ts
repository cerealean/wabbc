...
/**
 * Converts markdown tables to traditional BBCode format
 */
export class StandardTableConversionStrategy implements ConversionStrategy {
  convert(text: string, _format: 'bbcode' | 'worldanvil'): string {
    return this.convertTables(text);
  }

  /**
   * Convert markdown tables to traditional BBCode format
   */
